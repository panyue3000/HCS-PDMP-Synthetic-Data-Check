...
* DATE          : June 28, 2023
* MODIFICATIONS : Added measure 3.4
...
proc sql;
create table outcome_2_18_denom_step05_orig as
select unique a.*, b.community
...
set outcome_2_18_denom_step05_orig;
where 	(year = 2021 and month in (7,8,9,10,11,12)) or
		(year = 2022 and month in (1,2,3,4,5,6));
...
data outcome_2_18_denom_step05;
set outcome_2_18_denom_step05_orig
...
data outcome_3_3_step4; set outcome_3_3_step3;
