...
/*
Proc import files
	Merged_NDC_20220825.xlsx <- NYS file of NDC codes, with different compounds across different sheets
	Zipcodes for 3 communities.xlsx <- used to create HCS_zips1
*/
/* %include file
	"\\doh-smb\doh_shared\Projects\BNE\BNE_SCRIPT_DATA\CHIR_Format_new.sas";
*/
/*
pmplib lib files: 
	pmplib.healingpmp2022 lrh - note, won't need this for synthetic data
	pmplib.healingpmp2023 lrh - note, won't need this for synthetic data
	pmplib.zip - appears to be a zip SAS file that was stored in the pmplib defined below
*/
/*
fmtbasic lib files:
	FMTBASIC.FORMATS
...
Please sidestep the real code that would create the pmp_all through all_records_step_d files, these will get replaced
with the synthetic data*/ 

/*Other thoughts on stuff that's missing from this code*/
/*
1. Measure 3.3, measure 3.4
2. Study year stuff (20212022) - is this the right version even? are we missing updates? 
*/
...
/*Pan, you would skip the pmp_all setup steps for synthetic data validation, skipping ahead to 
