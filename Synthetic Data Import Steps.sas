...
numerator as KY_num,
Denominator as KY_den,
month,
quarter,
year
from &dset
where Reporterid in ('0101','0102') and year in (2020, 2021, 2022, 20212022)
...
%mend;
%convert_compare(Final_outcome_2_5_1_counts, '2.5.1');
%convert_compare(Final_outcome_2_7_1_counts, '2.7.1');

%convert_compare(Final_outcome_2_13_a_counts_2, '2.13A');
%convert_compare(Final_outcome_2_13_b_counts_2, '2.13B');
%convert_compare(Final_outcome_2_13_c_counts_2, '2.13C');
%convert_compare(Final_outcome_2_13_d_counts_2, '2.13D');

%convert_compare(Final_outcome_2_18_counts, '2.18');

%convert_compare(Final_outcome_3_1_counts, '3.1');
...
%convert_compare(Final_outcome_2_13_all_counts_2, '2.13.all');
%convert_compare(Final_outcome_2_13_e_counts_1, 'KY_2.13.e');
%convert_compare(Final_outcome_2_13_f_counts_1, 'KY_2.13.f');
